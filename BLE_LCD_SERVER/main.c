  ...
  while (1) {
      ...
      switch (BGLIB_MSG_ID(evt->header)) {
        ...
        case gecko_evt_system_boot_id:
        	...
        	sprintf(server_address_string,"%x:%x:%x:%x:%x:%x", server_address->addr[5],server_address->addr[4],server_address->addr[3],server_address->addr[2],server_address->addr[1],server_address->addr[0]);
        	//LCD_write("BLUETOOTH ADDRESS",LCD_ROW_BTADDR1);
        	LCD_write(server_address_string,LCD_ROW_BTADDR1);
        ...
        case gecko_evt_le_connection_opened_id:
        	...
        	LCD_write(client_address_string,LCD_ROW_BTADDR2);
