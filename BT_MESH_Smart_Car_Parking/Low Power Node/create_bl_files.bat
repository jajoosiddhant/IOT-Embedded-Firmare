...
if "%PATH_GCCARM%"=="" (
  set OBJCOPY="C:\SiliconLabsnew\developer\toolchains\gnu_arm\4.9_2015q3\bin\arm-none-eabi-objcopy.exe"
) else (
...
if "%PATH_SCMD%"=="" (
  set COMMANDER="C:\SiliconLabsnew\developer\adapter_packs\commander\commander.exe"
) else (
